...
export enum ErrorCodes {
  ...
  BUNDLE_INVALID_CONFIG = 'BUNDLE_INVALID_CONFIG',
  BUNDLE_DISCOVERY_FAILED = 'BUNDLE_DISCOVERY_FAILED',
  BUNDLE_DISABLED = 'BUNDLE_DISABLED',
  BUNDLE_HAS_DEPENDENTS = 'BUNDLE_HAS_DEPENDENTS',
  BUNDLE_DEPENDENCY_NOT_FOUND = 'BUNDLE_DEPENDENCY_NOT_FOUND',
  BUNDLE_DEPENDENCY_DISABLED = 'BUNDLE_DEPENDENCY_DISABLED',
  ...
  // Replicant errors
  REPLICANT_NOT_FOUND = 'REPLICANT_NOT_FOUND',
  REPLICANT_VALIDATION_FAILED = 'REPLICANT_VALIDATION_FAILED',
